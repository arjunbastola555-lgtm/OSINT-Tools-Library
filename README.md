...
7. Read the files inside with your browser or text editor
...
4. Double-click README.md if your system knows how to open it
5. If not, right-click it and choose **Open with**
6. Pick **Notepad**, **Notepad++**, or your browser
7. Add the pages you use often to your browser bookmarks
...
- `.md` files for readable text
- `.txt` files for notes
- folders with grouped resources
- links to web tools
